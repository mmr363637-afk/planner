...
export default function SettingsPage() {
  ...
  return (
    <div className="pb-8">
      ...
      {/* همگام‌سازی ابری — گوگل درایو (پیش‌فرض) یا Supabase */}
      <div className="mb-2">
        <Segmented
          value={s.cloudProvider ?? "drive"}
          onChange={(v) => updateSettings({ cloudProvider: v })}
          options={[
      ...
      {(s.cloudProvider ?? "drive") === "supabase" ? <SupabaseSyncCard /> : <GoogleDriveSyncCard />}
