...
| تنظیمات | تم روشن/تیره/سیستم، **تم رنگی دلخواه (۱۲ رنگ آماده + انتخاب هر رنگ دلخواه؛ کل اپ هماهنگ عوض می‌شود)**، پومودورو، فاصله‌ی مرورها، اعلان‌ها (۵ نوع)، ساعت شروع/پایان روز، Backup/Restore (JSON)، حذف همه‌ی داده‌ها |
