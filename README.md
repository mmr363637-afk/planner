...
| بخش | امکانات |
|---|---|
| خانه | سلام + تاریخ شمسی، **جمله‌ی انگیزشی روز** (۱۵۴ جمله؛ هر روز یکی، بدون تکرار تا حدود ۵ ماه + دکمه‌ی «بعدی»)، پیشرفت امروز (Ring + Progress)، کارهای امروز (شروع/تکمیل/جابه‌جایی/حذف)، مرورهای امروز، Streak/XP/مجموع مطالعه/تحقق هفتگی، بنر «عقب افتاده‌ای؛ Replan؟» |
...
| آمار | امروز/هفته/ماه، تعداد جلسات، مباحث تکمیل‌شده، تحقق برنامه، Streak، نمودار ۷ روز اخیر، نمودار بر اساس درس، **دستاوردها (گروه‌بندی‌شده + نوار پیشرفت کلی + «دستاورد بعدی»)** |
| گیمیفیکیشن | XP، سطح (نوآموز → استاد)، **۵۰ دستاورد** در ۷ گروه (زمان، مباحث، مرور، نظم، تداوم، عادت‌ها، تجربه) |
| تنظیمات | تم روشن/تیره/سیستم، **تم رنگی دلخواه (۱۲ رنگ آماده + انتخاب هر رنگ دلخواه؛ کل اپ هماهنگ عوض می‌شود)**، پومودورو، فاصله‌ی مرورها، اعلان‌ها (۵ نوع — **یادآور صبحگاهی با جمله‌ی انگیزشی همان روز**)، ساعت شروع/پایان روز، Backup/Restore (JSON)، حذف همه‌ی داده‌ها |
